...
<section id="special-price">
    <div class="container"><br><br>
        <h4 class="font-rubik font-size-20 text-center">Special Price</h4>
        ...
        <div class="grid">
            <?php array_map(function ($item) use($in_cart){ ?>
                <div class="grid-item border <?php echo $item['item_brand'] ?? "Brand" ; ?>">
                    <div class="item py-3" style="width: 204px;">
                            ...
                            <div class="text-center">
                                ...
                                <form method="post">
                                    ...
                                    if (in_array($item['item_id'], $in_cart ?? [])){
                                        ...
                                        echo '<button type="submit" name="special_price_submit" class="btn btn-warning font-size-12">Add to My Cart</button>';
                                    }
                                    ?>
                                </form>
                            </div>
